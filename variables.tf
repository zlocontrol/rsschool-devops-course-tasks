...
variable "gha_runner_ami_id" {
  description = "AMI для GitHub Actions Runner"
}

variable "gha_runner_instance_type" {
  description = "Тип EC2 для Runner"
  default     = "t2.micro"
}

variable "github_url" {
  description = "GitHub Org или User URL"
}
...
variable "runner_token" {
  description = "Registration token for Runner"
}

# SG для Runner
# output "gha_runner_sg_id" {
#   value = aws_security_group.gha_runner_sg.id
# }
