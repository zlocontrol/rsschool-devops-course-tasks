...
# --- Outputs for GitHub Actions Runner ---
output "gha_runner_id" {
  description = "The ID of the GitHub Actions self-hosted runner instance."
  value       = module.compute.gha_runner_id
}

output "gha_runner_private_ip" {
  description = "The private IP address of the GitHub Actions runner instance."
  value       = module.compute.gha_runner_private_ip
}
